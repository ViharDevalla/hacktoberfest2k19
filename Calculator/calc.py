...
if __name__ == "__main__": 
	...
	equation = StringVar() 	
	expression_field = Entry(gui,font=16,bg='black',fg='white',textvariable=equation) 	 
	expression_field.grid(columnspan=30,ipadx=26,ipady=30) 
	...
	plus = Button(gui, text=' + ', fg='white', bg='#454141', 
				command=lambda: press("+"), height=3, width=5) 
	plus.grid(row=2, column=3) 

	minus = Button(gui, text=' - ', fg='white', bg='#454141', 
				command=lambda: press("-"), height=3, width=5) 
	minus.grid(row=3, column=3) 

	multiply = Button(gui, text=' * ', fg='white', bg='#454141', 
					command=lambda: press("*"), height=3, width=5) 
	multiply.grid(row=4, column=3) 

	divide = Button(gui, text=' / ', fg='white', bg='#454141', 
					command=lambda: press("/"), height=3, width=5) 
	divide.grid(row=5, column=2) 

	equal = Button(gui, text=' = ', fg='white', bg='red', 
				command=equalpress, height=3, width=5) 
	equal.grid(row=5, column=3) 

	clear = Button(gui, text='Clear', fg='white', bg='#454141', 
